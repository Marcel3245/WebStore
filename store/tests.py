# We run a test on separate databese: .coverage
...
class TestCategoriesModels(TestCase):
    ...
    def test_category_model_entry(self):
        #Test Category model data insertion/types/field attributres
        data = self.data1
...
class TestProductModels(TestCase):
    ...
    def test_product_model_entry(self):
        #Test Product model data insertion/types/field attributres
        data = self.data1
