...
class RegistrationForm(forms.ModelForm):
    ...
    email                       = forms.EmailField(max_length=100, error_messages={'required': 'You need an email'})
...
class UserEditForm(forms.ModelForm):
    ...
    phone_number = forms.CharField(
        label='Phone number', min_length=4, max_length=10, widget=forms.TextInput(
    ...
    class Meta:
        model = UserBase
        fields = ('email', 'user_name', 'first_name', 'phone_number', 'address')
